...
class MultipartFormDataParametersTests: XCTestCase {
    ...
    func testDataEntitySuccess() {
        let value1 = "1".data(using: String.Encoding.utf8)!
        let value2 = "2".data(using: String.Encoding.utf8)!
        ...
        do {
            ...
            let regexp = try RegularExpression(pattern: pattern, options: [])
    ...
    // MARK: Values
    func testFileValue() {
        let fileURL = Bundle(for: self.dynamicType).urlForResource("test", withExtension: "json")!
        ...
        do {
            ...
            let testString = NSString(data: testData, encoding: String.Encoding.utf8.rawValue)!
